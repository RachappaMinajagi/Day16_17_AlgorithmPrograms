...
/*
 * @Purpose: MergeSort Sort
 * a.Desc: Logic -> To Merge Sort an array, we divide it into two halves, sort the two halves
...
public class MergeSort {
	...
	public static void main(String[] args) {
		...
		/*
		 * /Dividing array to sub arrays, fixing start to high index and merge to
		 * function
		 */
